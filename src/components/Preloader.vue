<template>
  <div class="preloader" :style="{ width : width + 'px', height: height + 'px' }">
    <div class="wBall" id="wBall_1"><div class="wInnerBall" /></div>
    <div class="wBall" id="wBall_2"><div class="wInnerBall" /></div>
    <div class="wBall" id="wBall_3"><div class="wInnerBall" /></div>
    <div class="wBall" id="wBall_4"><div class="wInnerBall" /></div>
    <div class="wBall" id="wBall_5"><div class="wInnerBall" /></div>
  </div>
</template>
